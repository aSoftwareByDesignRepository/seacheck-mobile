#!/usr/bin/env python3
"""Resume SeaCheck Play R5 from EN #4 (keep existing #1/#2/#3/#6), then full DE."""
...
print("R5_RESUME4_START", flush=True)
raw = m.DOCS / "_raw-live-en-US"
raw.mkdir(parents=True, exist_ok=True)

for need in ("01-map-hero.png", "02-map-passage.png", "03-passage-detail.png", "06-safety.png"):
    p = raw / need
